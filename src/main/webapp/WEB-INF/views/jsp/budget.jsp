...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="budget.html"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Budget</a></li>
			...
			<li><a href="LoginPage/index.html"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Login Page</a></li>
		</ul>
					...
					<div class="panel-body">
						...
						<div class="budgeted-block">
						    ...
						    <tr>
								...
								<th data-field="leftMoney" data-sortable="true">What's left</th>
						    </tr>
						    </thead>
						</table>
					</div>
